...
namespace _7DtD_LootViewer
{
    class lootContainernames
    {
        ...
        public static Dictionary<int,string> getNames()
        {
            ...
            tempNames.Add(20, "Air Conditioner (Not used-A13)");
            ...
            tempNames.Add(39, "Shotgun Messiah (Not used-A13)");
            ...
            tempNames.Add(57, "Miner's Chest (Not used-A13)");
            ...
            tempNames.Add(65, "Hazmat Gear (Not used-A13)");
